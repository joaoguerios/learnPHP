...
<body>
    ...
    <div class="title">
        <h2>Fornecedores - Cadastrar novo</h2>
    </div>
    <div class="principal">
        <div class="form">
            <form action="{{route('store.fornecedores.criar')}}" method="post">
                @csrf
                ...
                <button class="btn btn-dark rounded-pill px-3" type="submit">Cadastrar</button>
            </form>
        </div>
    </div>
